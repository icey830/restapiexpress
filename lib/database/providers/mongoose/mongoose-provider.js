...
var MongooseDbWriter = require('./mongoose-db-writer.js');
...
function MongooseProvider(config) {
    this.config = config;
    this.dbWriter = new MongooseDbWriter(config);
}
...
MongooseProvider.prototype.createEntity = function(data, resource, handleError, success)  {
    ...
    this.dbWriter.createEntity(data,resource,handleError,success);
