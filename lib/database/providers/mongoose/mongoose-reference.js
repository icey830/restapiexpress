...
MongooseReference.prototype.add = function()  {
    ...
    ReferencingDoc.findById( data[path.name], updateReferenceCallback(this.obj,this.referenceFields, this.errorCallback));
}
...
function updateReferenceCallback(obj, referenceFields, errorCallback) {
            ...
            if(referencingObject){
                ...
                referenceFields.forEach(function(referenceField) {
                    if(referenceField.isArray) {
                        updateArrayInReference(referencingObject, referenceField, obj);
                    } else {
                        updateFieldInReference(referencingObject, referenceField, obj);
                    }
...
function updateArrayInReference(referencingObject,referenceField, obj ) {
...
function updateFieldInReference(referencingObject,referenceField, obj ) {
