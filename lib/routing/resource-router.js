...
ResourceRouter.prototype.route = function(req, res) {
    ...
    Util.getFileFromFileSystem(apirouter.rootdir, apirouter.DOC_FOLDER, resource.documentation, evaluatePermissions, handle);
...
function evaluatePermissions(error, doc, handle) {
    ...
    Util.getFileFromFileSystem(apirouter.rootdir, apirouter.API_FOLDER, resource.restlet, sendResponse, handle);
}
