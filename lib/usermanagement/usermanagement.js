...
var Scope = require('../resource/scope');
...
Usermanagement.prototype.login = function(req, res) {
    ...
    if(req.body.username && req.body.password) {
        ...
        Util.getFileFromFileSystem(req.app.get("rootdir"),Usermanagement.DOC_FOLDER,resource.getDocumentationPath(), function(error, doc) {
            console.log("error?");
            if(error) {
