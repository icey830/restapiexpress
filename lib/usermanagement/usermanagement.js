...
Usermanagement.prototype.login = function(req, res) {
    ...
    if(req.body.username && req.body.password) {
        ...
        var docLoaded = function(doc) {
            ...
            resource.scope.push({"username":req.body.username});
            resource.scope.push({"password":req.body.password});
            resource.fields = "*";
            //TODO check username and password in resource
...
Usermanagement.prototype.signup = function(req, res) {
    res.json(200, {"message" : "successfully signed up"});
}
