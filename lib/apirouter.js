...
apirouter.versions = function(req, res) {
    ...
    req.role = role;
    var apidoc = require("./../api/versions.json");
    res.json(200, apidoc);
};
...
apirouter.docs = function(req, res) {
    ...
    var path = __dirname.substring(0,__dirname.length-4) + '/apidoc/v'+tmpPath[1]+"/"+tmpPath[2]+"/"+tmpPath[2]+".json";
...
apirouter.apidescription = function(req, res) {
    ...
    var path = __dirname.substring(0,__dirname.length-4) + '/api/'+ tmpPath[0]+"/"+req.method+"/"+role+"/instance.json";
...
apirouter.route = function (req, res) {
    ...
    var docLoaded = function(doc) {
        ...
        apirouter.getFileFromFileSystem(resource.restlet, 'api',res, sendRestlet);
    }
    apirouter.getFileFromFileSystem(resource.documentation,'apidoc', res, docLoaded);
