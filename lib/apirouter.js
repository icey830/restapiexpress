...
apirouter.login = function(req, res) {
...
exports.login = function (req, res) {
    ...
    apirouter.login(req, res);

};

apirouter.logout = function(req, res) {
    ...
    if(!req.session.username) {
        ...
        req.session.destroy();
        res.json(200, {"message" : "login failed"});
    }

};
exports.logout = function (req, res) {

    apirouter.logout(req, res);

};

apirouter.signup = function(req, res) {

    this.session(req, res);
    res.json(200, {"message" : "signup successfull"});
};
exports.signup = function (req, res) {

    apirouter.signup(req, res);
