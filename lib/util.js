 ...
 * @param subfolder
 * @param filePath
 * @param callback (error, file, object)
 * @param object object to pass throug
 */
Util.getFileFromFileSystem = function (rootdir, subfolder, filePath, callback, object) {
    var error = undefined;
    var file = undefined;
